...
- The isolated PR branch passes **429 tests across 36 files**, plus lint, TypeScript, and `git diff --check`. This excludes the unrelated onboarding and feedback work in the development checkout.
