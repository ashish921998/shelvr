        ...
        <div className="mt-8 space-y-8 text-[15px] leading-7 text-ink/90">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                relevant launch notification. The address is stored with our
                backend (Convex) and may be synced to our email-delivery
                provider (Resend) for that purpose. To unsubscribe or have your
                address deleted, email <strong>support@shelvr.app</strong>.
              </li>
              <li>
              ...
              <li>
                <strong>Product-search queries.</strong> If you use “Find links”
                on an item, a search query derived from that item may be sent to
                our product-search provider to return shopping results.
              </li>
              <li>
              ...
              <li>
                <strong>Product analytics.</strong> We use PostHog and
                ActivationPal to understand feature usage (for example
                onboarding completion and save events). In the app, analytics
                include a random device identifier and are tied to your account
                id after sign-in. On this website, we record a random anonymous
                identifier in your browser’s local storage and send basic usage
                events (such as page views, store CTA clicks, waitlist form
                interactions, and the page URL) to PostHog before you have an
                account. Website identifiers are not linked to your account or
                to your saved content, and no analytics data is used for
                advertising. We also use sampled session recordings in the app
                to investigate onboarding and purchase difficulties. Text and
                images are masked, and recording of console logs and network
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              our AI provider, product-search provider, Resend, PostHog, and
              ActivationPal), strictly to run the product, and where required by
              law.
            </p>
            <p className="mt-2">
              If you opt in through Shelvr’s updated-terms screen, RevenueCat
              may share purchase identifiers, delivery status, and whether
              sample content was provided with Apple to help review a refund
              request. This does not include your saved links, notes, photos, or
              product analytics events. We record your choice, the accepted
              terms version, and the time of your decision. You can turn sharing
              off in Profile. Changes are sent to RevenueCat; the app shows when
              an update is pending. Previously shared information cannot be
              recalled.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              events already recorded by PostHog or ActivationPal are not
              automatically erased by in-app deletion; email{" "}
              ...
              identifier. Deleting your Shelvr account does not cancel an App
              Store subscription — manage that in your Apple ID settings. You
              can also email <strong>support@shelvr.app</strong> for help.
            </p>
            <p className="mt-2">
